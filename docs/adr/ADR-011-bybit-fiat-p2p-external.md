...
- [docs/adr/ADR-006-cycle5-bybit-stream-authority-and-earn-subaccount.md](docs/adr/ADR-006-cycle5-bybit-stream-authority-and-earn-subaccount.md) §N16 part 2 / §N17 (BUY/SELL convention for external transfers; precedent used here).
