package com.walletradar.platform.networks.evm;
 ...
 *
 * <p>Not a Spring component — instantiated per backfill session in {@link com.walletradar.application.backfill.job.BackfillNetworkExecutor}.
 */
