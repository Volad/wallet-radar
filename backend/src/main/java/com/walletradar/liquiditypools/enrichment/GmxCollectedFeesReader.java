...
public class GmxCollectedFeesReader {
    ...
    private static final Map<NetworkId, String> GRAPHQL_URLS = Map.of(
            NetworkId.ARBITRUM, "https://gmx.squids.live/gmx-synthetics-arbitrum:prod/api/graphql",
            NetworkId.AVALANCHE, "https://gmx.squids.live/gmx-synthetics-avalanche:prod/api/graphql"
    );
    ...
    public Optional<BigDecimal> getCumulativeFeePerPoolValue(
        ...
        String graphqlUrl = GRAPHQL_URLS.get(networkId);
