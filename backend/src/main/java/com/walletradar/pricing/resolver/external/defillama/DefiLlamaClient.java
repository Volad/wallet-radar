package com.walletradar.pricing.resolver.external.defillama;
...
public class DefiLlamaClient {
    ...
    private static final String BASE_URL = "https://coins.llama.fi";
    private static final Duration TIMEOUT = Duration.ofSeconds(8);

    private final WebClient webClient;

    public DefiLlamaClient(WebClient.Builder builder) {
