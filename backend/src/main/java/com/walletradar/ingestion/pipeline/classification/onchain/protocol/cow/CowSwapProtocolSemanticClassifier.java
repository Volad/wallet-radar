...
public class CowSwapProtocolSemanticClassifier implements ProtocolSemanticClassifier {
    ...
    private boolean isEthFlowRequest(com.walletradar.ingestion.pipeline.onchain.OnChainRawTransactionView view) {
        if (view == null) {
            return false;
        }
    ...
    private boolean isSettlementCandidate(com.walletradar.ingestion.pipeline.onchain.OnChainRawTransactionView view) {
        if (view == null) {
            return false;
        }
    ...
    private boolean hasConfiguredTradeTopic(com.walletradar.ingestion.pipeline.onchain.OnChainRawTransactionView view) {
