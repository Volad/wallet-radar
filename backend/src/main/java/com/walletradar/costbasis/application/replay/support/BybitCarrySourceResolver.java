 ...
 * coverage ({@link #CARRY_SOURCE_COVERAGE_RATIO}), not by the wallet suffix or asset symbol, so no
...
public final class BybitCarrySourceResolver {
     ...
     * from real inventory (mirrors {@code TransferReplayHandler.CARRY_SOURCE_COVERAGE_RATIO}); the
