...
class ReplayDispatcherBybitCollapsedSelfTransferTest {
    ...
    void setUp() {
        dispatcher = new ReplayDispatcher(
                ...
                pendingTransferKeyFactory, transferReplayHandler, bybitVenueInternalReplayHandler,
    ...
    void fundCarryIn_isNotSkipped_whenCorrIdIsBybitCollapsed() {
        ...
        when(pendingTransferKeyFactory.usesCompositeContinuityBucket(any())).thenReturn(false);
