...
class ReplayDispatcherBybitEarnPrincipalMultiSourceTest {
    ...
    void inboundFirstUnpricedBundleStillPersistsEarnLedgerRowAndConsumesOutbounds() {
        ...
        TransferReplayHandler transferReplayHandler = new TransferReplayHandler(
                flowSupport,
                carryService,
                keyFactory,
                transferClassifier,
        ...
        ReplayDispatcher dispatcher = new ReplayDispatcher(
                ...
                mock(com.walletradar.costbasis.application.replay.support.LeverageBorrowReplayHook.class),
