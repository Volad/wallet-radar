...
class BorrowLiabilityTrackerTest {
    ...
    void unpricedMntBorrowCarriesMarketAtBorrowBasisInsteadOfZero() {
        ...
        com.walletradar.costbasis.application.replay.support.ReplayMarketAuthority marketAuthority =
                org.mockito.Mockito.mock(
                        com.walletradar.costbasis.application.replay.support.ReplayMarketAuthority.class);
        org.mockito.Mockito.when(marketAuthority.resolve(org.mockito.ArgumentMatchers.any(),
                        org.mockito.ArgumentMatchers.any()))
                .thenReturn(java.util.Optional.of(
                        new com.walletradar.costbasis.application.replay.support.ReplayMarketAuthority.ResolvedMarketPrice(
                                new BigDecimal("1.58"),
                                PriceSource.COINGECKO,
                                com.walletradar.costbasis.application.replay.support.ReplayMarketAuthority
