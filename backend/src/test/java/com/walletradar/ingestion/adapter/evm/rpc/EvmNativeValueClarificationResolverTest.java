...
class EvmNativeValueClarificationResolverTest {
    ...
    void clarify_usesTxValue_whenPositive() {
        ...
        assertThat(result.get().inferredFlows()).hasSize(1);
        assertThat(result.get().inferredFlows().get(0).getQuantityDelta()).isEqualByComparingTo("0.1");
    ...
    void clarify_fallsBackToWrappedNativeUnwrap_whenTxValueIsZero() {
        ...
        assertThat(result.get().inferredFlows().get(0).getQuantityDelta()).isEqualByComparingTo(expected);
    }
