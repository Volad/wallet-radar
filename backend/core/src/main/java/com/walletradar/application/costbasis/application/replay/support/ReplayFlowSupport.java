...
public class ReplayFlowSupport {
    ...
    public void applyBuyWithAcquisitionCost(
        ...
        boolean zeroNet = transaction != null
                && com.walletradar.application.costbasis.support.ZeroCostAcquisitionSupport.isZeroCostAcquisition(transaction.getType());
     ...
     * Tax cost uses market price; net cost uses the released net basis from the disposed asset
     * so that swapping a reward-derived (net=$0) asset does not raise Net AVCO.
     */
    public void applyBuyWithExplicitNetCost(
        ...
        genericFlowReplayEngine.applyBuyWithExplicitNetCost(flow, position, taxAcquisitionCostUsd, netAcquisitionCostUsd);
    }
    ...
    public BigDecimal pegFlooredStablecoinCarryBasis(
            com.walletradar.application.costbasis.application.replay.model.AssetKey assetKey,
