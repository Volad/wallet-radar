...
public class ZkSyncAaveGatewayClassifier implements OnChainFamilyClassifier {
    ...
    public Optional<ClassificationDecision> classify(OnChainClassificationContext context) {
        ...
        // ERC-20 Aave supply/withdraw that bypasses the registered pool address (router / smart-wallet
        // / relayer) is handled network-agnostically by RoutedAaveReceiptLendingClassifier; this
        // classifier owns only the native-ETH gateway selectors and borrow/repay debt shapes.
