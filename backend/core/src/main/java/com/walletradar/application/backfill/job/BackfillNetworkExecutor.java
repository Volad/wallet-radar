...
import com.walletradar.application.backfill.config.BackfillSegmentConfiguration;
import com.walletradar.application.backfill.config.BackfillSegmentsConfiguration;
...
public class BackfillNetworkExecutor {
    ...
    public void runBackfillForNetwork(String walletAddress, NetworkId networkId,
                                      NetworkAdapter adapter, com.walletradar.platform.networks.BlockHeightResolver heightResolver,
