...
public final class ReplayExecutionState {
    ...
    public com.walletradar.application.costbasis.application.replay.model.AsyncLifecycleBucket asyncLifecycleBucket(String correlationId) {
    ...
    public com.walletradar.application.costbasis.application.replay.model.AsyncSpotOrderBucket asyncSpotOrderBucket(String correlationId) {
        return asyncSpotOrderBuckets.bucket(CorrelationRef.from(correlationId));
    }

    public com.walletradar.application.costbasis.application.replay.model.AsyncSpotOrderBucket findAsyncSpotOrderBucket(String correlationId) {
        CorrelationRef correlationRef = CorrelationRef.from(correlationId);
