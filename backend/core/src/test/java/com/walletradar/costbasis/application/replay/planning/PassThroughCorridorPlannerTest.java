...
class PassThroughCorridorPlannerTest {
    ...
    void sameNetworkBridgeInPairsWithLendingDeposit() {
        ...
        assertThat(plan.byInboundFlowRef()).containsKey(com.walletradar.costbasis.application.replay.model.FlowRef.of(inboundFlowRef));
        assertThat(plan.byOutboundFlowRef()).containsKey(com.walletradar.costbasis.application.replay.model.FlowRef.of(outboundFlowRef));
    }
    ...
    void whenTwoBridgeInsWithSameQtyOnlyCorrectNetworkPairs() {
        ...
        assertThat(plan.byInboundFlowRef())
                .containsKey(com.walletradar.costbasis.application.replay.model.FlowRef.of(zkSyncInboundRef));
    }
    ...
    void bybitTransitCrossNetworkCorridorViaCounterpartyMatchStillWorks() {
        ...
        assertThat(plan.byInboundFlowRef())
                .containsKey(com.walletradar.costbasis.application.replay.model.FlowRef.of("bybit-in:0"));
        assertThat(plan.byOutboundFlowRef())
                .containsKey(com.walletradar.costbasis.application.replay.model.FlowRef.of("bybit-out:0"));
    }
