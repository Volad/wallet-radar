    ...
    private AvcoReplayService service() {
        ...
        com.walletradar.costbasis.application.replay.support.LeverageBorrowReplayHook leverageBorrowReplayHook =
                new com.walletradar.costbasis.application.replay.support.LeverageBorrowReplayHook(
                        new com.walletradar.application.normalization.pipeline.classification.support.LeverageAcquisitionDetector(),
                        borrowLiabilityTracker
                );
        com.walletradar.costbasis.application.replay.dispatch.ReplayRouteHandlerRegistry replayRouteHandlerRegistry =
                com.walletradar.costbasis.application.replay.dispatch.ReplayRouteHandlerRegistryFactory.create(
        ...
        return new AvcoReplayService(
                ...
                accountingUniverseService,
                org.mockito.Mockito.mock(com.walletradar.costbasis.application.replay.support.CorridorBasisConservationGuard.class),
                org.mockito.Mockito.mock(com.walletradar.costbasis.application.replay.support.BybitEarnSubPoolConservationGuard.class),
