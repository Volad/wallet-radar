...
class TransferReplayHandlerEarnPrincipalTest {
    ...
    private java.util.List<com.walletradar.application.costbasis.domain.AssetLedgerPoint> ledgerPoints;

    @BeforeEach
    void setUp() {
        var assetSupport = new com.walletradar.application.costbasis.application.replay.support.ReplayAssetSupport();
        var cache = mock(com.walletradar.application.pricing.persistence.HistoricalPriceCacheService.class);
        var orchestrator = mock(com.walletradar.application.pricing.resolver.external.PriceExternalSourceOrchestrator.class);
        ...
        when(cache.findQuote(any(), eq(PriceSource.BINANCE))).thenReturn(java.util.Optional.of(
                new com.walletradar.application.pricing.domain.PriceQuote(
                        new BigDecimal("3000"),
                        PriceSource.BINANCE,
    ...
    private java.util.List<com.walletradar.application.costbasis.domain.AssetLedgerPoint> earnSubPoolGhostPoints() {
