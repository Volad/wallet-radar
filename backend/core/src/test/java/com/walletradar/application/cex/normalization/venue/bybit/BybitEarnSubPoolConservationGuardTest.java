...
import com.walletradar.costbasis.application.replay.support.BybitEarnSubPoolConservationGuard;
...
class BybitEarnSubPoolConservationGuardTest {
    ...
    @Mock
    private BybitLiveBalanceReadPort bybitLiveBalanceReadPort;
    ...
    void reportsTrueCombinedLedgerQtyFromInMemoryPoints_andDoesNotFalselyWarnWhenMatched() {
        ...
        BybitEarnSubPoolConservationGuard guard = new BybitEarnSubPoolConservationGuard(bybitLiveBalanceReadPort);
        when(bybitLiveBalanceReadPort.findAll()).thenReturn(List.of(
    ...
    private static BybitLiveBalanceReadPort.Row liveBalance(
            String integrationId, String symbol, BigDecimal fundQty, BigDecimal earnQty, BigDecimal utaQty
    ) {
        return new BybitLiveBalanceReadPort.Row(integrationId, symbol, fundQty, earnQty, utaQty);
    }
}
