...
import com.walletradar.application.costbasis.domain.AssetFamilyResolver;
...
class CounterpartyBasisPoolTest {
    ...
    void setUp() {
        ...
        ReplayTransferClassifier transferClassifier = new ReplayTransferClassifier(
                new ReplayPendingTransferKeyFactory(new com.walletradar.application.costbasis.application.replay.support.ReplayAssetSupport())
        );
