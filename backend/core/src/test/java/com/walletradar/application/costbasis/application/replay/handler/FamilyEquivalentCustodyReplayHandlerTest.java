...
class FamilyEquivalentCustodyReplayHandlerTest {
    ...
    void protocolCustodyWithdrawWithEmptyPoolProducesAcquireNotReallocationForStablecoin() {
        ...
        ReplayExecutionState replayState = new ReplayExecutionState(
                com.walletradar.application.costbasis.application.replay.model.PassThroughCorridorPlan.empty(),
                collector
        );
    ...
    void lendingDepositCarriesFullUnderlyingBasisIntoReceiptAndConservesTotal() {
        ...
        com.walletradar.application.costbasis.application.replay.model.PositionState wethPosition = replayState.position(wethKey);
        ...
        com.walletradar.application.costbasis.application.replay.model.PositionState aWethPosition = replayState.position(aWethKey);
